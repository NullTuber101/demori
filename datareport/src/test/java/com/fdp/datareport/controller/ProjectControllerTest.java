...
class ProjectControllerTest {
    ...
    //  POST create project - invalid payload
    @Test
    void shouldReturn400WhenCreatingInvalidProject() throws Exception {
        Project invalidProject = new Project(); // Missing required fields
    ...
    //  PUT update project - invalid payload
    @Test
    void shouldReturn400WhenUpdatingInvalidProject() throws Exception {
        Project invalidProject = new Project(); // Missing required fields
